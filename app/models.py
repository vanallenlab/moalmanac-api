...
class Biomarkers(Base):
    ...
    marker = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    unit = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    equality = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    ...
    chromosome = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    start_position = sqlalchemy.Column(
        sqlalchemy.Integer,
        nullable=True,
    )
    end_position = sqlalchemy.Column(
        sqlalchemy.Integer,
        nullable=True,
    )
    reference_allele = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    alternate_allele = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    cdna_change = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    protein_change = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    variant_annotation = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    exon = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    rsid = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    hgvsg = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    hgvsc = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    requires_oncogenic = sqlalchemy.Column(
        sqlalchemy.Boolean,
        nullable=True,
    )
    requires_pathogenic = sqlalchemy.Column(
        sqlalchemy.Boolean,
        nullable=True,
    )

    rearrangement_type = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    locus = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    ...
    cytoband = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    arm = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
...
class Diseases(Base):
    ...
    concept_type = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=False,
    )
    name = sqlalchemy.Column(
...
class Indications(Base):
    ...
    indication = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=False,
    )
    initial_approval_date = sqlalchemy.Column(
        sqlalchemy.Date,
        nullable=True,
    )
    initial_approval_url = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    description = sqlalchemy.Column(
    ...
    raw_cancer_type = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    ...
    icd10 = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    regimen_code = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    reimbursement_category = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    reimbursement_date = sqlalchemy.Column(
        sqlalchemy.Date,
        nullable=True,
    )
    reimbursement_details = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    date_regular_approval = sqlalchemy.Column(
        sqlalchemy.Date,
        nullable=True,
    )
    date_accelerated_approval = sqlalchemy.Column(
        sqlalchemy.Date,
        nullable=True,
    )
...
class Therapies(Base):
    ...
    therapy_strategy_description = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
    ...
    therapy_type_description = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=True,
    )
...
class TherapyGroups(Base):
    ...
    membership_operator = sqlalchemy.Column(
        sqlalchemy.String,
        nullable=False,
    )
...
class AssociationBiomarkersAndGenes(Base):
    ...
    gene_id = sqlalchemy.Column(
        sqlalchemy.Integer,
        sqlalchemy.ForeignKey("genes.id"),
        nullable=False,
    )
...
class AssociationContributionsAndStatements(Base):
    ...
    contribution_id = sqlalchemy.Column(
        sqlalchemy.Integer,
        sqlalchemy.ForeignKey("contributions.id"),
        nullable=False,
    )
    statement_id = sqlalchemy.Column(
        sqlalchemy.Integer,
        sqlalchemy.ForeignKey("statements.id"),
        nullable=False,
    )
...
class AssociationDiseasesAndMappings(Base):
    ...
    mapping_id = sqlalchemy.Column(
        sqlalchemy.Integer,
        sqlalchemy.ForeignKey("mappings.id"),
        nullable=False,
    )
